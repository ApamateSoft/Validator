...
public class ValidatorRangeValueTest {

    private static final double MIN = 10.0;
    private static final double MAX = 30.0;
    private static final String[] NOT_PERMIT = { null, "", "9", "31" };
    private static final String[] PERMIT = { "10", "30", "20" };
    private static final String MESSAGES = String.format(new MessagesEn().getRangeValueMessage(), MIN, MAX);
